...
public class FragmentHearthRateInfo extends Fragment
{
			...
			Bundle savedInstanceState) 
	{
		...
		tv_param_1_content = (TextView)view.findViewById(R.id.tv_param_1_content);
		tv_param_2_content = (TextView)view.findViewById(R.id.tv_param_2_content);
		tv_param_3_content = (TextView)view.findViewById(R.id.tv_param_3_content);
		tv_param_4_content = (TextView)view.findViewById(R.id.tv_param_4_content);
		tv_param_5_content = (TextView)view.findViewById(R.id.tv_param_5_content);
		if (isShow) 
		{
			...
			if (LoginActivity.ret.getRet_code() == 0) 
			{
				...
				if (healthStat != null) 
				{
					...
					tv_param_3_content.setText(df.format(healthStat.getSdann()));
					tv_param_4_content.setText(df.format(healthStat.getSdnni()));
					tv_param_5_content.setText(df.format(healthStat.getR_mssd()));
				}
			} else 
			{
				Toast.makeText(view.getContext().getApplicationContext(), "获取健康信息失败：  " + LoginActivity.ret.getMsg(),
