...
public class DateTimePickDialogUtil implements OnDateChangedListener,
	...
	public AlertDialog dateTimePicKDialog(final EditText inputDate) {
		LinearLayout dateTimeLayout = (LinearLayout) activity
				.getLayoutInflater().inflate(R.layout.activity_time_select, null);
	...
	public void onDateChanged(DatePicker view, int year, int monthOfYear,
		...
		SimpleDateFormat sdf_input = new SimpleDateFormat("yyyy年MM月dd日 HH:mm");
		
		((NumberPicker)((ViewGroup)((ViewGroup)datePicker.getChildAt(0)).getChildAt(0)).getChildAt(1)).setDisplayedValues(mDisplayMonths);
		dateTime = sdf_input.format(calendar.getTime());
